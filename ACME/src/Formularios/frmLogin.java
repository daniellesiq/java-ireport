...
public class frmLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("INDÚSTRIA QUÍMICA ACME");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
       ...
       String senha = Encryption.md5(txtSenha.getText());
       //String senha = txtSenha.getText();
           
        ArrayList<Login> lista = lBUS.Consultar();
        
        for (Login lo : lista) {
            if (usuario.equals(lo.getUsuario()) && (Encryption.md5(senha).equals(Encryption.md5(lo.getSenha())))) {
               // Teste Senha
                //System.out.println(senha);
                //System.out.println(Encryption.md5(senha));
